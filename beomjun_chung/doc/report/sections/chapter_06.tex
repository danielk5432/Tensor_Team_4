...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\linewidth]{../../outputs/rank_sweep/lena/tucker_rank_sweep}
  \caption{PSNR (left axis) and compression ratio $\rho$ (right axis)
           as a function of Tucker rank $r$ (Lena image).
           HOOI ($\mathcal{L}_F$) with rank $(r,r,3)$.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{../../outputs/rank_sweep/lena/reconstruction_panel}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{../../outputs/noise_robustness/noise_comparison}
  \caption{Reconstruction under noise.
           Rows: different noise types and magnitudes.
           Columns: input, HOOI ($\mathcal{L}_F$), IRLS ($\mathcal{L}_1$).}
